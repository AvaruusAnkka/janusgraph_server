...
import Person from './models/vertexModel'
...
const requestNew = async (res: Response, result: object) => {
  try {
...
app
  ...
  .put((req: Request, res: Response) => {
    requestNew(res, VertexController.updateVertex(req.headers))
...
app
  .route('/vertex/all')
  .delete(async (req: Request, res: Response) =>
    VertexController.deleteAllVertices()
  )
...
app
  ...
  .post((req: Request, res: Response) => {
    requestNew(res, VertexController.addEdge(req.headers.from, req.headers.to))
    // if (
    //   req.headers.from &&
...
app.delete('/edge/all', async (req: Request, res: Response) =>
  VertexController.deleteEdges()
)

app.post('/faker', (req: Request, res: Response) => {
  VertexController.addVertex(res, new Person(fakePerson()))
})
